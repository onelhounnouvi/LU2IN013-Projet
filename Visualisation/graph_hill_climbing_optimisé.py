...
def evaluer_moyenne_scores(textes_chiffres, texte_ref, nb_permutations_list, n_gramme, 
    repetitions=25, stagnations_testees=[200]):
        ...
        for max_stagnation in stagnations_testees:
            ...
            for nb_permutations in nb_permutations_list:
                ...
                for _ in range(repetitions):
                    ...
                    texte_dechiffre, score_init, _, _= hill_climbing_optimise(
                        message_chiffre,
                        nb_permutations,
...
if __name__ == "__main__":
    ...
    textes_chiffres = {
        ...
        1150: file_to_str("Utilitaires/chiffres/chiffre_germinal_58_1150_2")
    }
