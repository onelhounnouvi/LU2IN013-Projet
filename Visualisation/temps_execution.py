...
def mesurer_temps_moyen_tabou(message, nb_iter, dico_ref, n, repetitions):
    total_time = 0
    for _ in range(repetitions):
        debut = time.time()
        recherche_tabou(message, nb_iter, dico_ref, n)
        fin = time.time()
        total_time += (fin - debut)
    return total_time / repetitions
...
if __name__ == "__main__":
    # Programme principal
    textes_chiffres = {
        110: file_to_str("Utilitaires/chiffres/chiffre_germinal_20_110_1"),
        205: file_to_str("Utilitaires/chiffres/chiffre_germinal_5_205_1"),
        318: file_to_str("Utilitaires/chiffres/chiffre_germinal_3_318_1"),
        509: file_to_str("Utilitaires/chiffres/chiffre_germinal_22_509_1")
    }

    # Paramètres pour le calcul des temps
    ...
    tabu_size = 220
    nb_iter = 310
    corpus_ref = file_to_str("Utilitaires/germinal_nettoye")
    ...
    for l in sorted(textes_chiffres.keys()):
        ...
        print(f"Sur texte à {l} caractères")
