...
def evaluer_hill_climbing_optimise_scores(textes_chiffres, dico_ref, nb_permutations_list, n_gramme_list):
    ...
    for taille, message_chiffre in textes_chiffres.items():
        ...
        for n in n_gramme_list:
            ...
            for nb_permutations in nb_permutations_list:
                ...
                texte_dechiffre,score_init = hill_climbing_optimise(message_chiffre, nb_permutations, dico_ref[n], n)
...
resultats = evaluer_hill_climbing_optimise_scores(textes_chiffres, dico_ngrams_ref, nb_permutations_list, n_gramme_list)
